...
function builPrevBtn(center_cdnt, colorArrow, colorBox, zoom, type) {
    let center = {
        x: center_cdnt.x,
        y: center_cdnt.y,
...
function polygon(initial_theta, p_dist, data) {
    ...
    builPrevBtn(prev_btn_cordinate, "#FFFFFF", "#000000", 0.7, "PREV")
    builPrevBtn(next_btn_cordinate, "#FFFFFF", "#000000", 0.7, "NEXT")
