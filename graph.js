...
function DrawGraph(data) {
	...
	for (var i = 0; i < data.length; i++) {
		...
		//Adject circle arc
		DrawCircle(this_center_x,this_center_y,attach_circle_r+adjt_circle_offset,line_cordinates[i].theta-(Math.PI/2) +Math.PI,line_cordinates[i].theta+(Math.PI/2)+Math.PI,10)
